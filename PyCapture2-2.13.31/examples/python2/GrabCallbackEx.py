...
def print_build_info():
    ...
    print 'FlyCapture2 library version: %d %d %d %d' % (lib_ver[0], lib_ver[1], lib_ver[2], lib_ver[3])
...
def grab_images(cam, num_images_to_grab):
    ...
    print 'Getting frame_rate!'
    frame_rate_property = cam.getProperty(PyCapture2.PROPERTY_TYPE.FRAME_RATE)
    frame_rate = frame_rate_property.absValue
...
# Print PyCapture2 Library Informatoin
print_build_info()
